...
int main(int argc, char *argv[])
{
        ...
        response.find("Content-Type: image/png") != string::npos)
    {
        ...
        system("xdg-open example1.jpeg"); // Replace with appropriate command for your OS
    }
    else
    {
        // Save HTML file
        ...
        system("xdg-open example.html"); // Replace with appropriate command for your OS
    }
